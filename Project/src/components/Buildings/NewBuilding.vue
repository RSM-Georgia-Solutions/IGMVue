  ...
  <v-form>
    ...
    <div class="text-xs-center">
      <v-btn
        ...
        color="blue-grey"
        class="white--text"
        @click.native="loader = 'loading3' ; BindBuilding"
      >
...
export default {
  ...
  data: () => ({
    ...
    Building: {
      ...
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQFtV26TrzDDse_Lb57HW8ns8XUMJgPTP8eNA7rX-51KK0Gu_tV",
