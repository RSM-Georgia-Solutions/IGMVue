                        ...
                        <v-container grid-list-md>
                            ...
                            <v-layout wrap>
                                ...
                                <v-flex xs12 sm6 md4>
                                    ...
                                    <v-text-field v-model="editedItem.vendorCode" placeholder="კოდი" label="კოდი" required :rules="vendorCodeRules"></v-text-field>
    
                                </v-flex>
    
                                <v-flex xs12 sm6 md4>
    
                                    <v-text-field v-model="editedItem.vendorName" placeholder="დასახელება" label="დასახელება" required :rules="vendorNameRules"></v-text-field>
    
                                </v-flex>
    
                                <v-flex xs12 sm6 md4>
    
                                    <v-text-field v-model="editedItem.contactPerson" placeholder="საკონტაკტო პირი" label="საკონტაკტო პირი"></v-text-field>
    
                                </v-flex>
    
                                <v-flex xs12 sm6 md4>
    
                                    <v-text-field v-model="editedItem.mobile" placeholder="ნომერი"   :rules="mobileRules" required></v-text-field>
    
                                </v-flex>
    
                                <v-flex xs12 sm6 md4>
    
                                    <v-text-field v-model="editedItem.Email" placeholder="Email" :rules="emailRules" required ></v-text-field>
    ...
    export default {
        ...
        computed: {
            ...
            formTitle() {
                ...
                return this.editedIndex === -1 ? 'ვენდორის დამატება' : 'ვენდორის კორეკტირება'
        ...
        methods: {
            ...
            deleteItem(item) {
                ...
                var confirmed = confirm('Are you sure you want to delete this item?') && this.Vendors.splice(index, 1)
            ...
            save() {
                ...
                if (this.editedIndex > -1) {
                    ...
                    axios.post('https://localhost:44317/api/vendors', this.editedItem)
