<template>
    <div>
                        ...
                        <v-container grid-list-md>
                            ...
                            <v-layout wrap>
                                ...
                                <v-flex xs12 sm12 md12>
                                    ...
                                    <v-text-field v-model="editedItem.itemCode" placeholder="კოდი" label="კოდი" required :disabled="editedIndex != -1"></v-text-field>
    
                                </v-flex>
                             
                                <v-flex xs12 sm12 md12>
    
                                    <v-text-field v-model="editedItem.itemName" placeholder="დასახელება" label="დასახელება" required :rules="itemNameRules"></v-text-field>
        ...
        <v-data-table :headers="headers" :items="ItemMasterData" :search="search">
        ...
        methods: {
            ...
            save() {
                ...
                if (this.editedIndex > -1) {
                    ...
                    axios.put(this.$store.state.baseUrl + '/itemmasterdata/', this.editedItem)
    
                        .then(res => {
    
                            Object.assign(this.ItemMasterData[this.editedIndex], this.editedItem)
                    ...
                    axios.post(this.$store.state.baseUrl + '/itemmasterdata/', this.editedItem)
